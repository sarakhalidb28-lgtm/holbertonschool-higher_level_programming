#!/usr/bin/python3
"""
هذا الموديل يحدد كلاس Rectangle مع إضافة التمثيل النصي __str__.
"""


class Rectangle:
    """كلاس يمثل مستطيل يحتوي على دوال الحساب والتمثيل النصي."""
    ...
    def __str__(self):
        """إرجاع تمثيل نصي للمستطيل باستخدام الرمز #."""
        if self.__width == 0 or self.__height == 0:
            return ""
