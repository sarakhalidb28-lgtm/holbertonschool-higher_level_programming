#!/usr/bin/python3
"""
هذا الموديل يحدد كلاس Rectangle مع رصد عملية حذف الكائنات __del__.
"""


class Rectangle:
    """كلاس يمثل مستطيل يحتوي على دوال الحساب والتمثيل النصي ورصد الحذف."""
    ...
    def __del__(self):
        """طباعة رسالة مخصصة عند حذف الكائن من الذاكرة."""
        print("Bye rectangle...")
